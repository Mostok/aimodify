...
class User extends Authenticatable implements HasMedia
{
     ...
     */
    protected $fillable = [
        'name', 'nickname', 'email', 'phone', 'twitch', 'about', 'youtube', 'level', 'avatar', 'balance', 'token', 'timezone', 'smiles', 'links', 'black_list_words','type', 'subscribers', 'avonline','streamviews', 'videoviews', 'bizdesc', 'products_for_advertisment', 'connection1', 'connection2', 'connection3', 'typeadver'
    ];
