...
/* Auth */ {
    ...
    Route::post('/auth/setusertype', ['uses' => 'Auth\AuthController@setUserType']);
}
...
/* Settings */ {
    ...
    Route::post('/settings/account/search', ['uses' => 'SettingsController@search']);
    Route::post('/settings/account/addgame', ['uses' => 'SettingsController@addgame']);
    Route::post('/settings/account/removegame', ['uses' => 'SettingsController@removegame']);
    // Donation Settings
    ...
    Route::post('/settings/screenshot', ['uses' => 'SettingsController@screenshot']);
}
...
/* Donation page */ {
    ...
    Route::post('/message/update', ['uses' => 'DonationsController@updateMessage', 'as' => 'donate.message.update']);
}
...
/* Widets */ {
    /* Video List */ {
        Route::get('/widgets/videobox', ['uses' => 'Widgets\VideoboxController@getHome', 'as' => 'widgets.videobox']);
    }
...
/* Pages */ {
    ...
    {
        Route::get('/media/all', ['uses' => 'MediaLibraryController@getHome', 'as' => 'media'])->where(['slug' => '[A-Za-z0-9-_]+']);
        Route::post('/media/add', ['uses' => 'MediaLibraryController@addMedia', 'as' => 'media.add']);
        Route::post('/media/remove', ['uses' => 'MediaLibraryController@removeMedia', 'as' => 'media.remove']);
    }
}
