        ...
        <nav class="menu">
            <ul class="nav metismenu" id="sidebar-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level in">
                        @if(Auth::user()->type == "Advertiser")
                            <li><a href="{{ route('widgets.videobox') }}"><i class="fa fa-video-camera fa-fw" aria-hidden="true"></i> Video Box</a></li>
                        @endif
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level in">
                        ...
                        <li><a href="{{ route('media') }}"><i class="fa fa-file-image-o fa-fw" aria-hidden="true"></i> Media Library</a></li>
