...
@section('modals')
    ...
    <div class="modal fade" id="donationCreate" tabindex="-1" role="dialog" aria-labelledby="donationCreateLabel">
        <div class="modal-dialog" role="document">
            {!! Form::open(['route' => 'donations.create', 'class' => 'modal-content form-horizontal', 'id' => 'donationCreateForm', 'autocomplete' => 'off', 'enctype'=>'multipart/form-data']) !!}
                                ...
                                <div class="input-group">
                                    <label class="input-group-btn">
                                        <span class="btn btn-secondary" style="border-radius: 0px;">
                                            @lang('global.browse') {!! Form::file('video_file', ['accept' => 'video/*', 'id' => 'video_file']) !!}
                                        </span>
                                    </label>
